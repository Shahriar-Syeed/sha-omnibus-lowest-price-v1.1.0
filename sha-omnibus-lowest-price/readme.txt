...
Shows the lowest recorded product price from the selected period for WooCommerce sale products.

== Features ==
* Displays the lowest recorded price for sale products in WooCommerce loops, product pages, Flatsome UX Builder product blocks, AJAX pagination, and Load More results.
* Displays the same Omnibus line in cart, mini-cart, and checkout rows.
...
== Changelog ==
= 1.1.0 =
* Added cart, mini-cart, and checkout display support.
* Added product edit price changes history for simple products and variations.
* Added admin settings for cart/checkout display and price-history panel.
